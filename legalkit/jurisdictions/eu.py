...
class EUJurisdiction(JurisdictionConfig):
    ...
    def __init__(self):
        ...
        self.legal_terms = {
            # Parties and actors
            "applicant", "defendant", "member state", "commission",
            "council", "parliament", "advocate general",
            
            # Courts and process
            "court of justice", "general court", "preliminary ruling",
            "preliminary reference", "infringement", "annulment",
            "opinion", "judgment", "order",
            
            # Principles
            "proportionality", "subsidiarity", "direct effect",
            "indirect effect", "supremacy", "consistent interpretation",
            "state liability", "effectiveness", "equivalence",
            
            # Legislation types
            "regulation", "directive", "decision", "recommendation",
            "opinion", "treaty", "charter",
            ...
            # Competition
            "undertaking", "dominant position", "abuse", "merger",
            "concentration", "state aid",
        }
