...
class LegalTrainer:
    ...
    def train(
        self,
        dataset: str | Path | LegalDataset,
        eval_dataset: str | Path | LegalDataset | None = None,
    ...
    def _prepare_dataset(self, dataset: str | Path | LegalDataset | None):
        ...
        if isinstance(dataset, LegalDataset):
            ...
            if self.config.anonymise_training_data:
                ds.preprocess(anonymise=True, jurisdiction=self.config.jurisdiction)
